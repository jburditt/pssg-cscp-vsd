...
public class InvoiceMapper : Profile
{
    public InvoiceMapper()
    {
        CreateMap<Vsd_Invoice, Invoice>()
            ...
            .ForMember(dest => dest.CvapStobId, opts => opts.MapFrom(src => src.Vsd_Cvap_SToBid.Id))
        ...
        CreateMap<Invoice, Vsd_Invoice>()
            ...
            //.ForMember(dest => dest.Vsd_Cvap_SToBid, opts => opts.MapFrom(src => src.CvapStobId != null ? new EntityReference())
