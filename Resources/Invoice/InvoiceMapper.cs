...
public class InvoiceMapper : Profile
{
    public InvoiceMapper()
    {
        CreateMap<Vsd_Invoice, Invoice>()
            ...
            .ForMember(dest => dest.CvapPaymentType, opts => opts.MapFrom(src => src.Vsd_Cvap_PaymentType))
            .ForMember(dest => dest.CvapNumberOfLineItems, opts => opts.MapFrom(src => src.Vsd_Cvap_NumberOfLineItems))
        ...
        CreateMap<Invoice, Vsd_Invoice>()
            ...
            .ForMember(dest => dest.Vsd_Cvap_PaymentType, opts => opts.MapFrom(src => src.CvapPaymentType))
            .ForMember(dest => dest.Vsd_Cvap_NumberOfLineItems, opts => opts.MapFrom(src => src.CvapNumberOfLineItems))
            .ForMember(dest => dest.Vsd_Cvap_SToBid, opts => opts.MapFrom(src => src.CvapStobId != null ? new EntityReference(Vsd_CvapStOB.EntityLogicalName, src.CvapStobId.Value) : null))
            ...
            .ForMember(dest => dest.Vsd_Origin, opts => opts.MapFrom(src => src.Origin))
