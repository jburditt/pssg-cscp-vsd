...
namespace Database.Model
{
	...
	[Microsoft.Xrm.Sdk.Client.RequestProxyAttribute("vsd_UploadCPUContractPackage")]
	public partial class Vsd_UploadCpuContractPackageRequest : Microsoft.Xrm.Sdk.OrganizationRequest
	{
		...
		public const string ActionLogicalName = "vsd_UploadCPUContractPackage";
		...
		public Microsoft.Xrm.Sdk.Entity SignedContract
		{
			get
			{
				if (this.Parameters.Contains("SignedContract"))
				{
					return ((Microsoft.Xrm.Sdk.Entity)(this.Parameters["SignedContract"]));
				}
				else
				{
			...
			set
			{
				this.Parameters["SignedContract"] = value;
			}
		}
		...
		public Vsd_UploadCpuContractPackageRequest()
		{
			this.RequestName = "vsd_UploadCPUContractPackage";
	...
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/vsd/")]
	[Microsoft.Xrm.Sdk.Client.ResponseProxyAttribute("vsd_UploadCPUContractPackage")]
	public partial class Vsd_UploadCpuContractPackageResponse : Microsoft.Xrm.Sdk.OrganizationResponse
	{
		...
		public Vsd_UploadCpuContractPackageResponse()
		{
		}
