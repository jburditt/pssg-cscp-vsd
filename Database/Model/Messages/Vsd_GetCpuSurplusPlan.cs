...
namespace Database.Model
{
	...
	[Microsoft.Xrm.Sdk.Client.RequestProxyAttribute("vsd_GetCPUSurplusPlan")]
	public partial class Vsd_GetCpuSurplusPlanRequest : Microsoft.Xrm.Sdk.OrganizationRequest
	{
		...
		public const string ActionLogicalName = "vsd_GetCPUSurplusPlan";
		...
		public Vsd_GetCpuSurplusPlanRequest()
		{
			this.RequestName = "vsd_GetCPUSurplusPlan";
	...
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/vsd/")]
	[Microsoft.Xrm.Sdk.Client.ResponseProxyAttribute("vsd_GetCPUSurplusPlan")]
	public partial class Vsd_GetCpuSurplusPlanResponse : Microsoft.Xrm.Sdk.OrganizationResponse
	{
		...
		public static class Fields
		{
			...
			public const string SurplusPlan = "SurplusPlan";
			public const string SurplusPlanLineItems = "SurplusPlanLineItems";
			public const string UserBcEId = "UserBcEId";
		}
		
		public const string ActionLogicalName = "vsd_GetCPUSurplusPlan";
		
		public Vsd_GetCpuSurplusPlanResponse()
		{
		}
		...
		public Microsoft.Xrm.Sdk.Entity SurplusPlan
		{
			get
			{
				if (this.Results.Contains("SurplusPlan"))
				{
					return ((Microsoft.Xrm.Sdk.Entity)(this.Results["SurplusPlan"]));
				}
				else
				{
					return default(Microsoft.Xrm.Sdk.Entity);
			...
			set
			{
				this.Results["SurplusPlan"] = value;
			}
		}
		
		public Microsoft.Xrm.Sdk.EntityCollection SurplusPlanLineItems
		{
			get
			{
				if (this.Results.Contains("SurplusPlanLineItems"))
				{
					return ((Microsoft.Xrm.Sdk.EntityCollection)(this.Results["SurplusPlanLineItems"]));
				}
				else
				{
					return default(Microsoft.Xrm.Sdk.EntityCollection);
			...
			set
			{
				this.Results["SurplusPlanLineItems"] = value;
			}
		}
